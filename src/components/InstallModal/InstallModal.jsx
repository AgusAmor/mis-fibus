        ...
        <div className="p-6 flex flex-col gap-5 bg-slate-50/50">
          {os === "ios" ? (
            <div className="flex flex-col gap-4">
              ...
              <ol className="flex flex-col gap-3 text-xs text-slate-600 pl-2 border-l-2 border-slate-200 ml-4">
                <li className="leading-relaxed">
                  <span className="font-bold mr-1">1.</span> Tocá el ícono de{" "}
                  <strong className="text-apple whitespace-nowrap">
                    <MdIosShare className="inline text-[13px] align-middle mr-0.5 relative -top-0.5" />
                    Compartir
                  </strong>{" "}
                  en la barra inferior.
                </li>
                <li className="leading-relaxed">
                  <span className="font-bold mr-1">2.</span> Seleccioná{" "}
                  <strong className="text-apple whitespace-nowrap">
                    <FaRegPlusSquare className="inline text-[13px] align-middle mr-1 relative -top-px" />
                    Agregar a Inicio
                  </strong>
                  .
                </li>
            ...
            <div className="flex flex-col gap-4">
              ...
              <ol className="flex flex-col gap-3 text-xs text-slate-600 pl-2 border-l-2 border-slate-200 ml-4">
                <li className="leading-relaxed">
                  <span className="font-bold mr-1">1.</span> En la barra
                  superior, a la derecha de la barra de búsqueda tocá el ícono
                  <strong className="text-success whitespace-nowrap">
                    <FaEllipsisV className="inline text-[13px] align-middle relative -top-px" />
                    Tres puntos
                  </strong>
                  .
                </li>
                <li className="leading-relaxed">
                  <span className="font-bold mr-1">2.</span> Seleccioná la
                  opción{" "}
                  <strong className="text-success">
                    <MdOutlineInstallDesktop className="inline text-[13px] align-middle mr-1 relative -top-px" />
            ...
            <div className="flex flex-col gap-5 overflow-y-auto max-h-[60vh] pr-2">
              <p className="text-sm text-slate-700 leading-relaxed font-semibold">
                Para la mejor experiencia, abrí esta página desde tu celular e
                instalá la App:
              </p>
