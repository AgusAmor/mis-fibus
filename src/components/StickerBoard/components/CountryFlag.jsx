  ...
  const renderFlagContent = (key) => {
    switch (key) {
      case "MEX": // Mexico: vertical green, white, red with simplified seal
        return (
          <>
            ...
            <rect x="10" y="0" width="10" height="20" fill="#f8fafc" />
      ...
      case "RSA": // South Africa: complex Y-band and triangle layout
        return (
          <>
            ...
            <path d="M0,0 L12,10 L0,20 L4,20 L14,12 L30,12 L30,8 L14,8 L4,0 Z" fill="#f8fafc" />
            {/* Green Y shape */}
            ...
            <path d="M0,3 L7,10 L0,17 Z" fill="#0f172a" />
          </>
        );
      ...
      case "KOR": // Korea Republic: white field, red/blue taegeuk, black trigrams
        return (
          <>
            <rect x="0" y="0" width="30" height="20" fill="#f8fafc" />
            ...
            <line x1="6" y1="5" x2="9" y2="3" stroke="#0f172a" strokeWidth="1.2" />
            <line x1="21" y1="3" x2="24" y2="5" stroke="#0f172a" strokeWidth="1.2" />
            <line x1="6" y1="15" x2="9" y2="17" stroke="#0f172a" strokeWidth="1.2" />
            <line x1="21" y1="17" x2="24" y2="15" stroke="#0f172a" strokeWidth="1.2" />
          </>
        );
      ...
      case "CZE": // Czechia: white top, red bottom, blue triangle
        return (
          <>
            <rect x="0" y="0" width="30" height="10" fill="#f8fafc" />
      ...
      case "CAN": // Canada: red-white-red vertical stripes with maple leaf
        return (
          <>
            ...
            <rect x="7.5" y="0" width="15" height="20" fill="#f8fafc" />
      ...
      case "BIH": // Bosnia-Herzegovina: blue field, yellow triangle, white dots
        return (
          <>
            ...
            <circle cx="9" cy="2" r="0.6" fill="#f8fafc" />
            <circle cx="11.5" cy="4.8" r="0.6" fill="#f8fafc" />
            <circle cx="14" cy="7.6" r="0.6" fill="#f8fafc" />
            <circle cx="16.5" cy="10.4" r="0.6" fill="#f8fafc" />
            <circle cx="19" cy="13.2" r="0.6" fill="#f8fafc" />
            <circle cx="21.5" cy="16" r="0.6" fill="#f8fafc" />
          </>
        );
      ...
      case "QAT": // Qatar: maroon field, white serrations
        return (
          <>
            ...
            <path d="M0,0 L7,0 L9.5,1 L7,2 L9.5,3 L7,4 L9.5,5 L7,6 L9.5,7 L7,8 L9.5,9 L7,10 L9.5,11 L7,12 L9.5,13 L7,14 L9.5,15 L7,16 L9.5,17 L7,18 L9.5,19 L7,20 L0,20 Z" fill="#f8fafc" />
          </>
        );
      ...
      case "SUI": // Switzerland: square cross representation on red
        return (
          <>
            ...
            <rect x="13.5" y="4.5" width="3" height="11" fill="#f8fafc" />
            <rect x="9.5" y="8.5" width="11" height="3" fill="#f8fafc" />
          </>
        );
      ...
      case "BRA": // Brazil: green field, yellow rhombus, blue circle, white stripe
        return (
          <>
            ...
            <path d="M12.5,11 C13.5,10.2 15.5,10.2 17.5,11" stroke="#f8fafc" strokeWidth="0.6" fill="none" />
          </>
        );
      ...
      case "HAI": // Haiti: blue/red horizontal stripes, white emblem box
        return (
          <>
            ...
            <rect x="11.5" y="6.5" width="7" height="7" fill="#f8fafc" />
      ...
      case "SCO": // Scotland: blue with white saltire
        return (
          <>
            ...
            <line x1="0" y1="0" x2="30" y2="20" stroke="#f8fafc" strokeWidth="2.5" />
            <line x1="30" y1="0" x2="0" y2="20" stroke="#f8fafc" strokeWidth="2.5" />
          </>
        );
      ...
      case "USA": // USA: red/white stripes, blue canton, white dots
        return (
          <>
            ...
            <circle cx="2.5" cy="2.5" r="0.4" fill="#f8fafc" />
            <circle cx="5" cy="2.5" r="0.4" fill="#f8fafc" />
            <circle cx="7.5" cy="2.5" r="0.4" fill="#f8fafc" />
            <circle cx="10" cy="2.5" r="0.4" fill="#f8fafc" />
            <circle cx="3.5" cy="5" r="0.4" fill="#f8fafc" />
            <circle cx="6" cy="5" r="0.4" fill="#f8fafc" />
            <circle cx="8.5" cy="5" r="0.4" fill="#f8fafc" />
            <circle cx="2.5" cy="7.5" r="0.4" fill="#f8fafc" />
            <circle cx="5" cy="7.5" r="0.4" fill="#f8fafc" />
            <circle cx="7.5" cy="7.5" r="0.4" fill="#f8fafc" />
            <circle cx="10" cy="7.5" r="0.4" fill="#f8fafc" />
          </>
        );
      ...
      case "PAR": // Paraguay: red, white, blue horizontal stripes with emblem
        return (
          <>
            ...
            <rect x="0" y="6.7" width="30" height="6.7" fill="#f8fafc" />
            <rect x="0" y="13.4" width="30" height="6.6" fill="#0038A8" />
            <circle cx="15" cy="10" r="1.8" fill="#f8fafc" stroke="#0038A8" strokeWidth="0.4" />
      ...
      case "AUS": // Australia: blue field, Union Jack canton, white stars
        return (
          <>
            ...
            <line x1="0" y1="0" x2="15" y2="10" stroke="#f8fafc" strokeWidth="1.2" />
            <line x1="15" y1="0" x2="0" y2="10" stroke="#f8fafc" strokeWidth="1.2" />
            <line x1="0" y1="0" x2="15" y2="10" stroke="#FF0000" strokeWidth="0.5" />
            <line x1="15" y1="0" x2="0" y2="10" stroke="#FF0000" strokeWidth="0.5" />
            <rect x="6" y="0" width="3" height="10" fill="#f8fafc" />
            <rect x="0" y="3.5" width="15" height="3" fill="#f8fafc" />
            <rect x="7" y="0" width="1" height="10" fill="#FF0000" />
            <rect x="0" y="4.5" width="15" height="1" fill="#FF0000" />
            {/* Southern Cross representation */}
            <circle cx="22.5" cy="4" r="0.5" fill="#f8fafc" />
            <circle cx="22.5" cy="16" r="0.5" fill="#f8fafc" />
            <circle cx="27" cy="8" r="0.5" fill="#f8fafc" />
            <circle cx="27" cy="12.5" r="0.5" fill="#f8fafc" />
            <circle cx="24.5" cy="10" r="0.3" fill="#f8fafc" />
            <circle cx="7.5" cy="15" r="0.8" fill="#f8fafc" />
          </>
        );
      ...
      case "TUR": // Türkiye: red background, white crescent and star
        return (
          <>
            ...
            <circle cx="13" cy="10" r="3.8" fill="#f8fafc" />
            <circle cx="14.4" cy="10" r="3" fill="#E30A17" />
            <polygon points="18.5,8.8 18.9,10 20.1,10 19.1,10.8 19.5,12 18.5,11.2 17.5,12 17.9,10.8 16.9,10 18.1,10" fill="#f8fafc" />
          </>
        );
      ...
      case "GER": // Germany: black, red, yellow stripes
        return (
          <>
            <rect x="0" y="0" width="30" height="6.7" fill="#0f172a" />
      ...
      case "CUW": // Curaçao: blue background, yellow stripe, two stars
        return (
          <>
            ...
            <circle cx="4" cy="4" r="0.8" fill="#f8fafc" />
            <circle cx="7.2" cy="6.2" r="0.5" fill="#f8fafc" />
          </>
        );
      ...
      case "TUN": // Tunisia: red field, white circle, crescent & star
        return (
          <>
            ...
            <circle cx="15" cy="10" r="4.2" fill="#f8fafc" />
            <circle cx="15.5" cy="10" r="2.2" fill="#E20909" />
            <circle cx="16.5" cy="10" r="1.7" fill="#f8fafc" />
      ...
      case "BEL": // Belgium: black, yellow, red stripes
        return (
          <>
            <rect x="0" y="0" width="10" height="20" fill="#0f172a" />
      ...
      case "EGY": // Egypt: red, white, black stripes with emblem
        return (
          <>
            ...
            <rect x="0" y="6.7" width="30" height="6.7" fill="#f8fafc" />
            <rect x="0" y="13.4" width="30" height="6.6" fill="#0f172a" />
      ...
      case "NZL": // New Zealand: blue field, Union Jack, red stars
        return (
          <>
            ...
            <circle cx="22.5" cy="4.5" r="0.6" fill="#f8fafc" />
            <circle cx="22.5" cy="4.5" r="0.3" fill="#CC0A2C" />
            <circle cx="22.5" cy="15.5" r="0.6" fill="#f8fafc" />
            <circle cx="22.5" cy="15.5" r="0.3" fill="#CC0A2C" />
            <circle cx="26.5" cy="9.5" r="0.6" fill="#f8fafc" />
            <circle cx="26.5" cy="9.5" r="0.3" fill="#CC0A2C" />
            <circle cx="18.5" cy="10" r="0.5" fill="#f8fafc" />
      ...
      case "CPV": // Cabo Verde: blue field, striped bands, circle of stars
        return (
          <>
            ...
            <rect x="0" y="10" width="30" height="1.4" fill="#f8fafc" />
            <rect x="0" y="11.4" width="30" height="1.4" fill="#CE1126" />
            <rect x="0" y="12.8" width="30" height="1.4" fill="#f8fafc" />
      ...
      case "KSA": // Saudi Arabia: green field, white elements
        return (
          <>
            ...
            <rect x="8" y="7" width="14" height="2.2" fill="#f8fafc" />
            <line x1="7" y1="12" x2="23" y2="12" stroke="#f8fafc" strokeWidth="1" />
          </>
        );
      ...
      case "URU": // Uruguay: striped layout with canton sun
        return (
          <>
            ...
            <rect x="0" y="0" width="10.5" height="10.5" fill="#f8fafc" />
      ...
      case "NOR": // Norway: red field, white-bordered blue cross
        return (
          <>
            ...
            <rect x="9" y="0" width="4" height="20" fill="#f8fafc" />
            <rect x="0" y="8" width="30" height="4" fill="#f8fafc" />
      ...
      case "ALG": // Algeria: green, white vertical split, crescent & star
        return (
          <>
            ...
            <rect x="15" y="0" width="15" height="20" fill="#f8fafc" />
            <circle cx="15" cy="10" r="3" fill="#D21034" />
            <circle cx="16.2" cy="10" r="2.4" fill="#f8fafc" />
      ...
      case "JOR": // Jordan: striped layout with red triangle, white star
        return (
          <>
            ...
            <circle cx="4" cy="10" r="0.7" fill="#f8fafc" />
          </>
        );
      ...
      case "POR": // Portugal: green/red vertical split with emblem
        return (
          <>
            ...
            <rect x="11.5" y="9" width="1" height="2" fill="#f8fafc" />
          </>
        );
      ...
      case "CRO": // Croatia: red, white, blue stripes with checkers shield
        return (
          <>
            ...
            <rect x="13.5" y="5.2" width="3" height="3.6" fill="#FF0000" stroke="#f8fafc" strokeWidth="0.3" />
            <rect x="14" y="5.7" width="1" height="1" fill="#f8fafc" />
            <rect x="15" y="6.7" width="1" height="1" fill="#f8fafc" />
          </>
        );
      ...
      case "GHA": // Ghana: red, yellow, green stripes with center black star
        return (
          <>
            ...
            <polygon points="15,7.8 15.5,9.5 17.2,9.5 15.8,10.5 16.3,12.2 15,11.2 13.7,12.2 14.2,10.5 12.8,9.5 14.5,9.5" fill="#0f172a" />
          </>
        );
      ...
      case "PAN": // Panama: four quarters, blue & red stars representation
        return (
          <>
            <rect x="0" y="0" width="15" height="10" fill="#f8fafc" />
            <rect x="15" y="0" width="15" height="10" fill="#D21034" />
            <rect x="0" y="10" width="15" height="10" fill="#005293" />
            <rect x="15" y="10" width="15" height="10" fill="#f8fafc" />
