...
/**
 * StickerGroup — collapsible accordion for a named group (Special section or Group Stage).
 *
 * Responsibilities:
 *  - Render the group header with icon, title, percent complete, and progress bar.
 *  - Expand/collapse body on click.
 *  - For special sections: render a flat sticker grid.
 *  - For group stages: render a CountrySection accordion per country.
 */
