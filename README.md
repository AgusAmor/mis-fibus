...
*   **Sincronización de Salas:** Mediante un parámetro en la URL o un código de sala en las configuraciones, asociás la app a una base de datos específica. El código de tu sala queda guardado en tu teléfono de forma persistente.
...
### ⭐ Sistema de Favoritas y Repetidas
...
*   **Compartir Repetidas:** Al filtrar por "Repetidas", un botón premium te permite compilar automáticamente toda tu lista de duplicadas y compartirla vía redes sociales (Web Share API) o copiarla a tu portapapeles.
...
*   **Modos de Visualización:**
    *   *Álbum:* Acordeones por selecciones y grupos.
    *   *Equipos:* Lista directa de los 48 países.
    *   *Especiales:* Sólo escudos, historia y especiales.
    *   *Continua:* Grilla plana sin divisiones.
...
graph TD
    ...
    A["📱 Celular A (App Instalada)"] <-->|Sincronización en Tiempo Real| FS[("🔥 Cloud Firestore (Nube)")]
    B["📱 Celular B (App Instalada)"] <-->|Sincronización en Tiempo Real| FS
...
<p align="center">
  <i>Mis Fibus • Creado con ⚽ para hacer del coleccionismo una aventura de a dos.</i>
</p>
